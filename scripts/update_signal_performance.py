...
def main():
    ...
    parser.add_argument(
        "--hours-back", type=int, default=720, help="Kaç saat geriye bak (default: 720 = 30 gün)"
    )
    parser.add_argument(
        "--max-signals",
        type=int,
        default=None,
        help="Maksimum sinyal sayısı (default: None = hepsi)",
    )
    ...
    try:
        ...
        result = analyzer.batch_update_performance(
            hours_back=args.hours_back, max_signals=args.max_signals
        )
