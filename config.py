...
class Config:
    ...
    # 1m-türetme (10 Tem 2026 cutover): sadece kline_1m'e WS abone olunur (543 stream),
    # diğer TF'ler utils/timeframe_aggregator.py ile 1m buffer'ından türetilir (gerçek
    # veriyle doğrulandı: kapanmış barlarda tam eşleşme, forming barlarda ~2-3sn'lik
    ...
    MIN_VOLUME_THRESHOLD = (
        10000  # Bir sembolün izlenmesi için gereken minimum 24 saatlik hacim (USDT)
    )
