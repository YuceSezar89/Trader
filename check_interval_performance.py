...
def check_interval_performance():
    ...
    try:
        ...
        print("=" * 100)
        print(
            f"{'Interval':<10} {'Total':<10} {'Calculated':<12} {'Pending':<10} {'No Record':<12} {'Oldest':<20} {'Newest':<20}"
        )
        print("-" * 100)
        ...
        for row in results:
            ...
            print(
                f"{interval:<10} {total:<10} {calculated:<12} {pending:<10} {no_record:<12} {str(oldest):<20} {str(newest):<20}"
            )
